# FireOps CRM - Database Migration Guide
...
### Step 1: ADDDING a Migration
Run this whenever you change your C# Domain Models (like adding a new property or table).
...
### Need further help?
If you ever get an "Entity Framework tools are not installed" error, run this first:
